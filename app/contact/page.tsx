      ...
      <div className="flex items-center justify-center gap-4 w-4/5">
        {active == 1 ? (
          <button
            ...
            className={
              "h-full flex flex-[3] p-4 flex-col gap-y-10 rounded-2xl items-center justify-center  transition-all ease-in "
            }
          >
            ...
            <div className="flex flex-row items-center justify-center gap-x-2">
              ...
              <div className="flex flex-col gap-y-1 items-start justify-start ">
                <span>Ange Kano Stephane</span>
                <span>Front-end developper, 21 ans</span>
        ...
        {active == 3 ? (
          <button
            ...
            className={
              "h-full flex flex-[3] flex-col gap-y-10 rounded-2xl items-center justify-center  transition-all ease-in "
            }
          >
